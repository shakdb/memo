...
.memo.hash:{[obj]    / obj - any kdb object
...
.memo.ize:{[funcName]
  err:"error (.memo.ize): expected the symbol/string name of a (pure) function";
  ...
  str,:"  cacheKey:`$raze string .memo.hash (",(";"sv string params),");\r\n";
